...
public final class ActivityEducationBinding implements ViewBinding {
  ...
  private ActivityEducationBinding(@NonNull ConstraintLayout rootView,
      @NonNull LinearLayout bottomLayout, @NonNull MaterialButton btnAddEducation,
      ...
      @NonNull LinearLayout containerEducation, @NonNull ConstraintLayout headerLayout,
  ...
  public static ActivityEducationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btnAddEducation;
      MaterialButton btnAddEducation = ViewBindings.findChildViewById(rootView, id);
      if (btnAddEducation == null) {
        break missingId;
      }
      ...
      return new ActivityEducationBinding((ConstraintLayout) rootView, bottomLayout,
          btnAddEducation, btnBack, btnNext, btnPrevious, btnSaveDraft, containerEducation,
